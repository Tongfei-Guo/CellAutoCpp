...
class Model
{
	...
	friend class Cell;
public:
	Model(world_param_type param, std::vector<grid_param_type> types = {}, unsigned size = 1, getcolor_type getcolor_func = nullptr); // TODO : error-check user input percent is within 0 - 100, and all percentage sum up to 100.
