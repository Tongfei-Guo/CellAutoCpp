...
int main()
{
    ...
    CAWorld world3(Model(world_param_type(50, 50, 6), { grid_param_type("Wall", 100, process, reset, init) },1));
    ...
    world3.AddMeasureAndRun(new CADistributionMeasure("Final Dist"));

    for(auto m: world3.GetMeasures())
